...
Leverage refers to the influence a single data point has on the fitted regression line. A diagonal element (i,i) of the hat matrix, denoted by $h_{ii}$, captures this influence for the i-th data point. The value of h_ii ranges from 0 to 1.
